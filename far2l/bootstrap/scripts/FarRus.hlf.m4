...
папкам. Каждое сочетание (#Ctrl-Shift-0..9#) может содержать до #1000# записей.
Для создания закладки на текущую папку нужно нажать #Ctrl-Shift-0..9#. Чтобы
...
#Enter# для перехода.
 ...
 #Клавиатурные команды подменю:#
   ...
   #Shift+Вверх# Поменять этот слот местами со слотом выше.
   #Shift+Вниз#  Поменять этот слот местами со слотом ниже.
   #Esc#         Закрыть подменю.
...
панель.
    ...
    Примечание: слот #9# автоматически используется для записи посещённых
    панелей плагинов (до 50 записей) для быстрой навигации по истории.
