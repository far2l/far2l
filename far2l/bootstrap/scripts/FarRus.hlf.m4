...
папкам. Каждый слот #0-8# может содержать до #1000# записей. Слот #9# —
особый автоматически записываемый слот, ограниченный #50# записями для
посещённых панелей плагинов. Для создания закладки на текущую папку нужно нажать #Ctrl-Shift-0..9#. Чтобы
перейти в папку, записанную в закладке, нажмите #ПравыйCtrl-0..9#. Если
#ПравыйCtrl-0..9# нажат в строке редактирования, то путь закладки будет
вставлен в эту строку. Закладки также доступны в меню перехода.

    Если нажать #ПравыйCtrl-0..9# на закладке, содержащей более одной записи,
откроется #подменю# со всеми записями в этом слоте. Выберите запись и нажмите
#Enter# для перехода.

 #Клавиатурные команды подменю:#

   #Enter#       Перейти к выделенной записи.
   #Ins#         Добавить текущую папку как новую запись в этот слот.
   #Del#         Удалить выделенную запись из этого слота.
   #F4#          Изменить путь выделенной записи.
   #Shift+Вверх# Поменять эту запись местами с записью выше.
   #Shift+Вниз#  Поменять эту запись местами с записью ниже.
   #Esc#         Закрыть подменю.

 #Клавиатурные команды главного меню закладок:#

   #Shift+Вверх# Поменять выделенный слот местами со слотом выше.
   #Shift+Вниз#  Поменять выделенный слот местами со слотом ниже.
...
панель.
    ...
    Диагностическая информация записывается в #~~/.config/far2l/bookmarks.log#
(в активном корневом каталоге настроек, см. ключ #-u# или переменную окружения
~$FARSETTINGS~@FAREnv@).
